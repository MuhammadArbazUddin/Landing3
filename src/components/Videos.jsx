...
const Videos = () => {
  return (
    <section className="px-4 flex flex-col lg:flex-row items-center lg:items-stretch">
      {/* Left Section */}
      ...
      <div className="lg:w-1/2 p-4">
        <h1 className="text-3xl sm:text-5xl lg:text-8xl font-bold text-center px-4">
      ...
      <div className="lg:w-1/4 p-4">
        <div className="flex flex-col items-center gap-8">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center">
            500+ <br />
            <span className="text-sm sm:text-base font-thin">
